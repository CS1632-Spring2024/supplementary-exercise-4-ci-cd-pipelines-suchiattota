...
public class RentACatIntegrationTest {
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse(ret);
		assertTrue(c2.getRented());
		assertEquals("Old Deuteronomy has been rented." + newline + "Sorry, Old Deuteronomy is not here!" + newline, out.toString());
	}
	...
	public void testReturnCatNumCats3() {
		...
		//Postconditions
		assertTrue(ret);
		assertEquals("Old Deuteronomy has been rented." + newline + "Welcome back, Old Deuteronomy!" + newline, out.toString()); 
	}
